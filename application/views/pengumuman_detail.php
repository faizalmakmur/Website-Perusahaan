...
<body>
        ...
        <span style="color: black; font-size: 20px; font-family: Montserrat, sans-serif;"> Marga Trans Nusantara</span>
			...
			<nav id="navbar" class="navbar">
				...
				<ul>
					...
					<li><a href="<?= base_url("sejarah"); ?>"><span>PROFIL</span></a>
    ...
    <div id="content" class="text-white d-flex align-items-end">
        ...
        <a href="<?= base_url("pengumuman") ?>"><h1 data-aos="slide-right" style="font-family: Montserrat; color: white;">Detail Pengumuman</h1></a>
    ...
    <div class="row">
        <nav aria-label="breadcrumb" class="mt-4">
            <ol class="breadcrumb">
                <li class="breadcrumb-item text-dark"><a href="<?= base_url("pengumuman") ?>" class="text-dark link-underline link-underline-opacity-0">Pengumunan</a></li>
                <li class="breadcrumb-item"><strong>Pengumuman Detail</strong></li>
            </ol>
        </nav>
    </div>
</div>
