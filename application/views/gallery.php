...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
		...
		<a class="logo" href="<?= base_url() ?>">
			...
			<nav id="navbar" class="navbar">
				<div>
				<ul>
					<li><a class="nav-link scrollto" href=href="<?= base_url() ?>">BERANDA</a></li>
    ...
    <div id="content" class="text-white d-flex align-items-end">
        <div class="container mb-4">
            <h1 data-aos="slide-right">Galeri</h1>
    ...
    <div class="row">
        <nav aria-label="breadcrumb" class="mt-4">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><strong>Galeri</strong></li>
            </ol>
        </nav>
    </div>
</div>
                                ...
                                <div class="row" data-aos="fade-up" data-aos-delay="100">
                                    <div class="col-lg-12 d-flex justify-content-center">
                                        <ul id="portfolio-flters">
                                            ...
                                            <li data-filter=".filter-1">Agenda Daerah</li>
                                            <li data-filter=".filter-2">Bakti Sosial</li>
                                            <li data-filter=".filter-3">Pertemuan</li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    ?>
                                        <div class="col-lg-4 col-md-6 portfolio-item filter-<?= $galeri['jenis'] ?>">
                                            ...
                                            <div class="portfolio-info">
                                                <a href="<?= base_url("assets/images/gallery/" . $galeri['desc']) ?>" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="<?= $galeri['judul'] ?>"><i class="bx bx-zoom-in"></i></a>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
