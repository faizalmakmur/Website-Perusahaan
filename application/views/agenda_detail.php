...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
		...
		<a class="logo" href="<?= base_url() ?>">
                <img src="<?= base_url('assets/images/mtn.png') ?>" alt="Gambar MTN" height="60px">
    ...
    <div id="content" class="text-white d-flex align-items-end">
        ...
        <a href="<?= base_url("agenda") ?>"><h1 data-aos="slide-right" style="font-family: Montserrat; color: white;">Detail Agenda</h1></a>
    ...
    <div class="row">
        <nav aria-label="breadcrumb" class="mt-4">
            <ol class="breadcrumb">
                <li class="breadcrumb-item text-dark"><a href="<?= base_url("agenda") ?>" class="text-dark link-underline link-underline-opacity-0">Agenda</a></li>
                <li class="breadcrumb-item"><strong>Agenda Detail</strong></li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <footer class="shadow-lg sticky-bottom">
        <div class="container py-5">
            <div class="row g-3 p-0">
                ...
                <img src="<?= base_url('assets/images/jm.png') ?>" alt="Gambar JM" height="60px">
                </div>
